...
IMAGE_TAG?=latest
HTTPS_GIT := https://github.com/akhirachain/akhiranode.git
DOCKER := $(shell which docker)
DOCKER_BUF := $(DOCKER) run --rm -v $(CURDIR):/workspace --workdir /workspace bufbuild/buf

ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=akhirachain \
		  -X github.com/cosmos/cosmos-sdk/version.ServerName=akhiranoded \
		  -X github.com/cosmos/cosmos-sdk/version.ClientName=akhiranoded \
