...
import (
	...
	"github.com/AkhiraChain/akhiranode/x/dispensation/test"
	"github.com/AkhiraChain/akhiranode/x/dispensation/types"
	dispensationUtils "github.com/AkhiraChain/akhiranode/x/dispensation/utils"
...
func TestNewHandler_CreateDistribution_PayRewardsInAnyToken_HappyCase(t *testing.T) {
	...
	for i := 0; i < len(msgAirdropOutput); i++ {
		...
		assert.True(t, msgAirdropOutput[i].Coins.AmountOf("catk").Equal(sdk.NewInt(10)) ||
			msgAirdropOutput[i].Coins.AmountOf("ceth").Equal(sdk.NewInt(10)) || msgAirdropOutput[i].Coins.AmountOf("aku").Equal(sdk.NewInt(10)))
	}
	...
	for i := 0; i < len(outputList); i++ {
		...
		assert.True(t, keeper.GetBankKeeper().GetBalance(ctx, lpAddess, "ceth").Amount.Equal(sdk.NewInt(10)) ||
			keeper.GetBankKeeper().GetBalance(ctx, lpAddess, "catk").Amount.Equal(sdk.NewInt(10)) || keeper.GetBankKeeper().GetBalance(ctx, lpAddess, "aku").Amount.Equal(sdk.NewInt(10)))
	}
	...
	for i := 0; i < len(msgLiquidityMiningOutput); i++ {
		...
		assert.True(t, msgLiquidityMiningOutput[i].Coins.AmountOf("catk").Equal(sdk.NewInt(10)) ||
			msgLiquidityMiningOutput[i].Coins.AmountOf("ceth").Equal(sdk.NewInt(10)) || msgLiquidityMiningOutput[i].Coins.AmountOf("aku").Equal(sdk.NewInt(10)))
	}
	...
	for i := 0; i < len(msgUnspecifiedOutput); i++ {
		...
		assert.True(t, msgUnspecifiedOutput[i].Coins.AmountOf("catk").Equal(sdk.NewInt(10)) ||
			msgUnspecifiedOutput[i].Coins.AmountOf("ceth").Equal(sdk.NewInt(10)) || msgUnspecifiedOutput[i].Coins.AmountOf("aku").Equal(sdk.NewInt(10)))
	}
	...
	for i := 0; i < len(msgValidatorSubsidyOutput); i++ {
		...
		assert.True(t, msgValidatorSubsidyOutput[i].Coins.AmountOf("catk").Equal(sdk.NewInt(10)) ||
			msgValidatorSubsidyOutput[i].Coins.AmountOf("ceth").Equal(sdk.NewInt(10)) || msgValidatorSubsidyOutput[i].Coins.AmountOf("aku").Equal(sdk.NewInt(10)))
	}
}
