...
import (
	...
	dispensationkeeper "github.com/AkhiraChain/akhiranode/x/dispensation/keeper"
...
func GenerateQueryData(app *app.AkhiraApp, ctx sdk.Context, name string, outList []bank.Output) {
