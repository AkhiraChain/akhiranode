...
Create
```shell
akhiranoded tx dispensation create ValidatorSubsidy output.json ak1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --from ak1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0aku
```
Run
```shell
akhiranoded tx dispensation run 2_ak1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd ValidatorSubsidy --from ak1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0aku
```
