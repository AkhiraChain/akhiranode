...
import (
	...
	"github.com/AkhiraChain/akhiranode/x/clp/types"
)
...
func CreateTestApp(isCheckTx bool) (*sifapp.AkhiraApp, sdk.Context) {
...
func CreateTestAppClp(isCheckTx bool) (sdk.Context, *sifapp.AkhiraApp) {
