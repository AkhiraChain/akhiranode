...
import (
	...
	"github.com/AkhiraChain/akhiranode/app/ante"
...
func TestAdjustGasPriceDecorator_AnteHandle(t *testing.T) {
	...
	otherMsg := banktypes.NewMsgSend(addrs[0], addrs[1], sdk.NewCoins(sdk.NewCoin("aku", sdk.NewIntFromUint64(100))))
...
func TestAdjustGasPriceDecorator_AnteHandle_MinFee(t *testing.T) {
	...
	addrs := sifapp.AddTestAddrs(app, ctx, 6, initTokens)
	decorator := ante.AdjustGasPriceDecorator{}
	highFee := sdk.NewCoins(sdk.NewCoin("aku", sdk.NewInt(100000000000000000))) // 0.1
	lowFee := sdk.NewCoins(sdk.NewCoin("aku", sdk.NewInt(10000000000000000)))   // 0.01

	sendMsg := banktypes.NewMsgSend(addrs[0], addrs[1], sdk.NewCoins(sdk.NewCoin("aku", sdk.NewIntFromUint64(100))))
