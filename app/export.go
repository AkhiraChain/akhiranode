...
// file.
func (app *AkhiraApp) ExportAppStateAndValidators(
...
func (app *AkhiraApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
...
func ExportAppState(name string, app *AkhiraApp, ctx sdk.Context) {
