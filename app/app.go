...
import (
	...
	akhirachainAnte "github.com/AkhiraChain/akhiranode/app/ante"
	"github.com/AkhiraChain/akhiranode/x/clp"
	clpkeeper "github.com/AkhiraChain/akhiranode/x/clp/keeper"
	clptypes "github.com/AkhiraChain/akhiranode/x/clp/types"
	"github.com/AkhiraChain/akhiranode/x/dispensation"
	dispkeeper "github.com/AkhiraChain/akhiranode/x/dispensation/keeper"
	disptypes "github.com/AkhiraChain/akhiranode/x/dispensation/types"
	"github.com/AkhiraChain/akhiranode/x/ethbridge"
	ethbridgekeeper "github.com/AkhiraChain/akhiranode/x/ethbridge/keeper"
	ethbridgetypes "github.com/AkhiraChain/akhiranode/x/ethbridge/types"
	ibctransferoverride "github.com/AkhiraChain/akhiranode/x/ibctransfer"
	sctransfertypes "github.com/AkhiraChain/akhiranode/x/ibctransfer/types"
	"github.com/AkhiraChain/akhiranode/x/oracle"
	oraclekeeper "github.com/AkhiraChain/akhiranode/x/oracle/keeper"
	oracletypes "github.com/AkhiraChain/akhiranode/x/oracle/types"
	"github.com/AkhiraChain/akhiranode/x/tokenregistry"
	tokenregistrykeeper "github.com/AkhiraChain/akhiranode/x/tokenregistry/keeper"
...
const appName = "akhiranode"

var (
	DefaultNodeHome = os.ExpandEnv("$HOME/.akhiranoded")
...
var (
	_ simapp.App              = (*AkhiraApp)(nil)
	_ servertypes.Application = (*AkhiraApp)(nil)
)

type AkhiraApp struct {
	*baseapp.BaseApp
...
func NewAkhiraApp(
	...
	*/
	...
	anteHandler, err := akhirachainAnte.NewAnteHandler(
		ante.HandlerOptions{
...
func (app *AkhiraApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *AkhiraApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

func (app *AkhiraApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

func (app *AkhiraApp) LegacyAmino() *codec.LegacyAmino { //nolint
...
func (app *AkhiraApp) AppCodec() codec.Codec {
	return app.appCodec
}
...
func (app *AkhiraApp) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

func (app *AkhiraApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *AkhiraApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *AkhiraApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// LoadHeight loads a particular height
func (app *AkhiraApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *AkhiraApp) ModuleAccountAddrs() map[string]bool {
...
func (app *AkhiraApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
// API server.
func (app *AkhiraApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *AkhiraApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *AkhiraApp) RegisterTendermintService(clientCtx client.Context) {
