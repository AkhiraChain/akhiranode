...
akiranoded keys add mkey --multisig sif,akasha --multisig-threshold 2
...
akiranoded add-genesis-account $(akiranoded keys show mkey -a) 500000000000000000000000aku
...
cp $GOPATH/bin/akiranoded $DAEMON_HOME/cosmovisor/upgrades/release-20210414000000/bin/
