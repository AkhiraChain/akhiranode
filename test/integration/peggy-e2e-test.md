...
# end to end test
## start truffle, akhiranoded and relayer
1. open a console
cd smart-contracts
yarn develop
...
akhiranoded query account $(akhiranoded keys show user2 -a)

yarn peggy:lock $(akhiranoded keys show user2 -a) 0x0000000000000000000000000000000000000000 1000000000000000000
...
akhiranoded tx ethbridge burn $(akhiranoded keys show user2 -a) 0xf17f52151EbEF6C7334FAD080c5704D77216b732 1000000000000000000 peggyeth --ethereum-chain-id=5777 --from=user2 --yes

3. check user2's account 
yarn peggy:getTokenBalance 0xf17f52151EbEF6C7334FAD080c5704D77216b732 eth
akhiranoded query account $(akhiranoded keys show user2 -a)

### case 3: lock aku in cosmos then issue the token in ethereum
akhiranoded tx ethbridge lock $(akhiranoded keys show user2 -a) 0xf17f52151EbEF6C7334FAD080c5704D77216b732 1 rwn  --ethereum-chain-id=5777 --from=user2 --yes
...
### case 4: burn aku in ethereum and aku will be back to cosmos
yarn peggy:burn $(akhiranoded keys show user2 -a) 0x409Ba3dd291bb5D48D5B4404F5EFa207441F6CbA 1
