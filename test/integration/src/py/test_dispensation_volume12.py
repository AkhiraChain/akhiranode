...
def test_run_online_morethan10distribution_txn(claimType):
    ...
    time.sleep(5)
    send_sample_aku(from_address, destaddress10, sampleamount, keyring_backend, chain_id, "")
    time.sleep(5)
    send_sample_aku(from_address, destaddress11, sampleamount, keyring_backend, chain_id, "")
    time.sleep(5)
    send_sample_aku(from_address, destaddress12, sampleamount, keyring_backend, chain_id, "")
    time.sleep(5)
    ...
    dict10 = {"denom": "aku", "amount": "15000"}
    dict11 = {"denom": "aku", "amount": "16000"}
    dict12 = {"denom": "aku", "amount": "17000"}
