...
def test_transfer_tokens_with_some_currency(ctx_legacy):
    ...
    aku_source_integrationtest_env_credentials = ctx.aku_source_integrationtest_env_credentials
    aku_source_integrationtest_env_transfer_request = ctx.aku_source_integrationtest_env_transfer_request(basic_transfer_request)
