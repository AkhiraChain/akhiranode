...
try:
    test_utilities.get_shell_output(f"akiranoded keys delete user1 --home /home/vagrant/.akiranoded --keyring-backend test -o json")
except:
...
test_utilities.get_sifchain_addr_balance(request.sifchain_address, request.akiranoded_node, "ceth")
