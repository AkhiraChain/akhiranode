...
def test_bulk_transfers(
    ...
    for a in new_addresses:
        ...
        test_utilities.wait_for_sifchain_addr_balance(a, "ceth", amount, basic_transfer_request.akhiranoded_node, 180)
        test_utilities.wait_for_sifchain_addr_balance(a, "aku", amount, basic_transfer_request.akhiranoded_node, 180)
